...
def import_airfoil_aerodynamic_data(airfoil_name):
    ...
    airfoil_aerodynamic_data_filepath = get_filepath('World/Profiles/AerodynamicData/', 'xf-' + airfoil_name + '-il-200000.csv')
...
def import_airfoil_coordinates(airfoil_name):
    ...
    airfoil_coordinates_filepath = get_filepath('World/Profiles/Coordinates/', airfoil_name + '.dat')
    ...
    return df_array_x.values, df_array_y.values # vetores de coordenadas horizontais e verticais
