...
def test_moment_on_CG():
    ...
    cg_parameters = {"x": 0.15, "z": 0.2}
    cg = CG(cg_parameters)

    npt.assert_almost_equal(
        aerodynamic_surface.moment_on_CG(aerodynamic_surface_parameters, cg, 3.1), 1
    )
...
CM_surface_alpha3 = aerodynamic_surface.moment_on_CG(aerodynamic_surface, cg, 3.0)
